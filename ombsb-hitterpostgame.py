...
# Create the figure with adjustable size
    ...
    legend1 = legend_ax.legend(handles=handles1, title='Pitch Call', loc='lower left', bbox_to_anchor=(0.0, -0.3), fontsize=10, title_fontsize=12)
    ...
    legend2 = legend_ax.legend(handles=handles2, title='Pitch Type', loc='lower left', bbox_to_anchor=(0.0, -0.3), fontsize=10, title_fontsize=12)
